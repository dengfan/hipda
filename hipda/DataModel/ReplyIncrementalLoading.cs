...
{
    public class ReplyIncrementalLoading<T> : ObservableCollection<T>, ISupportIncrementalLoading
    {
        // 是否正在异步加载中
        ...
        public ReplyIncrementalLoading(uint totalCount, Func<int, int, List<T>> getDataFunc)
        {
