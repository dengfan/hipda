...
{
    public sealed class MyRefLink : Control
    {
        public MyRefLink()
        {
            this.DefaultStyleKey = typeof(MyRefLink);
        }
        ...
        public static readonly DependencyProperty PostIdProperty =
            DependencyProperty.Register("PostId", typeof(int), typeof(MyRefLink), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty ThreadIdProperty =
            DependencyProperty.Register("ThreadId", typeof(int), typeof(MyRefLink), new PropertyMetadata(0));
