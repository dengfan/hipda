...
{
    public class MyListViewForUserMessageList : ListView
    {
        ...
        public static readonly DependencyProperty SelectedUserMessageListItemsProperty =
            DependencyProperty.Register("SelectedUserMessageListItems", typeof(IList<object>), typeof(MyListViewForUserMessageList), new PropertyMetadata(null));
