...
namespace Hipda.Client.Uwp.Pro.ViewModels
{
    public class ThreadItemForSearchTitleViewModel : ThreadItemViewModelBase
    {
        ...
        public ThreadItemForSearchTitleViewModel(int pageNo, int threadId, int threadAuthorUserId, ListView replyListView, Action beforeLoad, Action<int, int> afterLoad)
        {
            StartPageNo = 1;
            ThreadDataType = ThreadDataType.SearchTitle;
            _threadId = threadId;
